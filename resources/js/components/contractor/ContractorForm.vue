...
import { ContractorFormData } from '@/composables';

defineProps<FormProps>();

const { form } = injectFormContext<ContractorFormData>();
</script>
...
<template>
    <FormContent class="sm:grid-cols-2">
        ...
        <FormField required class="col-start-1">
            <FormLabel>
                <CapitalizeText>
                    {{ $t('models.contractor.fields.first_name') }}
                </CapitalizeText>
            </FormLabel>
            <FormControl>
        ...
        <FormField required>
            <FormLabel>
                <CapitalizeText>
                    {{ $t('models.contractor.fields.last_name') }}
                </CapitalizeText>
            </FormLabel>
            <FormControl>
