...
<template>
    <div
        class="bg-secondary text-secondary-foreground flex aspect-square size-8 items-center justify-center rounded-md"
    >
        <TeamLogoIcon class="size-full bg-inherit text-inherit" :media="team.logo" />
    </div>
