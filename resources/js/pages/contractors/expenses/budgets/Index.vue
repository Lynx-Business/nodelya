...
import {
    ContractorExpenseBudgetIndexProps,
...
const props = defineProps<ContractorExpenseBudgetIndexProps>();
            ...
            alert({
                ...
                callback: () =>
                    router.delete<ExpenseBudgetOneOrManyRequest>(
                        route('contractors.expenses.budgets.trash', {
            ...
            alert({
                ...
                callback: () =>
                    router.patch<ExpenseBudgetOneOrManyRequest>(
                        route('contractors.expenses.budgets.restore', {
                            contractor: props.contractor,
                        }),
    ...
    },
    {
        ...
        callback: (budgets) =>
            alert({
                ...
                callback: () =>
                    router.delete<ExpenseBudgetOneOrManyRequest>(
                        route('contractors.expenses.budgets.delete', {
                            contractor: props.contractor,
                        }),
                        {
                            data: { ids: budgets.map(({ id }) => id) },
...
const rowActions: DataTableRowAction<ExpenseBudgetResource>[] = [
    {
        ...
        href: (expenseBudget) =>
            route('contractors.expenses.budgets.edit', {
                contractor: props.contractor,
                expenseBudget,
            }),
    },
...
const filters = useFilters<ExpenseBudgetIndexRequest>(
    route('contractors.expenses.budgets.index', {
        contractor: props.contractor,
    }),
    {
        q: props.request.q ?? '',
