...
import {
    EmployeeExpenseChargeIndexProps,
...
const props = defineProps<EmployeeExpenseChargeIndexProps>();
            ...
            alert({
                ...
                callback: () =>
                    router.delete<ExpenseChargeOneOrManyRequest>(
                        route('employees.expenses.charges.trash', {
            ...
            alert({
                ...
                callback: () =>
                    router.patch<ExpenseChargeOneOrManyRequest>(
                        route('employees.expenses.charges.restore', {
                            employee: props.employee,
                        }),
    ...
    },
    {
        ...
        callback: (charges) =>
            alert({
                ...
                callback: () =>
                    router.delete<ExpenseChargeOneOrManyRequest>(
                        route('employees.expenses.charges.delete', {
                            employee: props.employee,
                        }),
                        {
                            data: { ids: charges.map(({ id }) => id) },
...
const rowActions: DataTableRowAction<ExpenseChargeResource>[] = [
    {
        ...
        href: (expenseCharge) =>
            route('employees.expenses.charges.edit', {
                employee: props.employee,
                expenseCharge,
            }),
    },
...
const filters = useFilters<ExpenseChargeIndexRequest>(
    route('employees.expenses.charges.index', {
        employee: props.employee,
    }),
    {
        q: props.request.q ?? '',
