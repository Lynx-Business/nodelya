...
team: TeamListResource;
accountingPeriods?: {data:Array<AccountingPeriodResource>;links:Array<{url:string;label:string;active:boolean;}>;meta:{current_page:number;first_page_url:string;from:number;last_page:number;last_page_url:string;next_page_url:string;path:string;per_page:number;prev_page_url:string;to:number;total:number;};};
...
banners?: {data:Array<BannerAdminIndexResource>;links:Array<{url:string;label:string;active:boolean;}>;meta:{current_page:number;first_page_url:string;from:number;last_page:number;last_page_url:string;next_page_url:string;path:string;per_page:number;prev_page_url:string;to:number;total:number;};};
};
...
billing_deals?: {data:Array<DealResource>;links:Array<{url:string;label:string;active:boolean;}>;meta:{current_page:number;first_page_url:string;from:number;last_page:number;last_page_url:string;next_page_url:string;path:string;per_page:number;prev_page_url:string;to:number;total:number;};};
...
clients?: {data:Array<ClientResource>;links:Array<{url:string;label:string;active:boolean;}>;meta:{current_page:number;first_page_url:string;from:number;last_page:number;last_page_url:string;next_page_url:string;path:string;per_page:number;prev_page_url:string;to:number;total:number;};};
trashedFilters?: Array<{value:TrashedFilter;label:string;}>;
};
...
accounting_period_months: Array<any>;
commercial_deals?: {data:Array<DealResource>;links:Array<{url:string;label:string;active:boolean;}>;meta:{current_page:number;first_page_url:string;from:number;last_page:number;last_page_url:string;next_page_url:string;path:string;per_page:number;prev_page_url:string;to:number;total:number;};};
trashed_filters?: Array<{value:TrashedFilter;label:string;}>;
accountingPeriods?: Array<AccountingPeriodResource>;
clients?: Array<ClientResource>;
};
...
contractor: ContractorResource;
expenseBudgets?: {data:Array<ExpenseBudgetResource>;links:Array<{url:string;label:string;active:boolean;}>;meta:{current_page:number;first_page_url:string;from:number;last_page:number;last_page_url:string;next_page_url:string;path:string;per_page:number;prev_page_url:string;to:number;total:number;};};
trashedFilters?: Array<{value:TrashedFilter;label:string;}>;
accountingPeriods?: Array<AccountingPeriodResource>;
expenseCategories?: Array<ExpenseCategoryResource>;
expenseSubCategories?: Array<ExpenseSubCategoryResource>;
...
contractor: ContractorResource;
expenseCharges?: {data:Array<ExpenseChargeResource>;links:Array<{url:string;label:string;active:boolean;}>;meta:{current_page:number;first_page_url:string;from:number;last_page:number;last_page_url:string;next_page_url:string;path:string;per_page:number;prev_page_url:string;to:number;total:number;};};
trashedFilters?: Array<{value:TrashedFilter;label:string;}>;
accountingPeriods?: Array<AccountingPeriodResource>;
expenseCategories?: Array<ExpenseCategoryResource>;
expenseSubCategories?: Array<ExpenseSubCategoryResource>;
...
contractors?: {data:Array<ContractorResource>;links:Array<{url:string;label:string;active:boolean;}>;meta:{current_page:number;first_page_url:string;from:number;last_page:number;last_page_url:string;next_page_url:string;path:string;per_page:number;prev_page_url:string;to:number;total:number;};};
trashedFilters?: Array<{value:TrashedFilter;label:string;}>;
accountingPeriods?: Array<AccountingPeriodResource>;
projectDepartments?: Array<ProjectDepartmentResource>;
};
...
employees?: {data:Array<EmployeeResource>;links:Array<{url:string;label:string;active:boolean;}>;meta:{current_page:number;first_page_url:string;from:number;last_page:number;last_page_url:string;next_page_url:string;path:string;per_page:number;prev_page_url:string;to:number;total:number;};};
trashedFilters?: Array<{value:TrashedFilter;label:string;}>;
accountingPeriods?: Array<AccountingPeriodResource>;
projectDepartments?: Array<ProjectDepartmentResource>;
};
...
expenseType: ExpenseType;
expenseCategories?: {data:Array<ExpenseCategoryResource>;links:Array<{url:string;label:string;active:boolean;}>;meta:{current_page:number;first_page_url:string;from:number;last_page:number;last_page_url:string;next_page_url:string;path:string;per_page:number;prev_page_url:string;to:number;total:number;};};
trashedFilters?: Array<{value:TrashedFilter;label:string;}>;
};
...
expenseTypes?: Array<{value:ExpenseType;label:string;}>;
expenseType: ExpenseType;
expenseItems?: {data:Array<ExpenseItemResource>;links:Array<{url:string;label:string;active:boolean;}>;meta:{current_page:number;first_page_url:string;from:number;last_page:number;last_page_url:string;next_page_url:string;path:string;per_page:number;prev_page_url:string;to:number;total:number;};};
trashedFilters?: Array<{value:TrashedFilter;label:string;}>;
expenseCategories?: Array<ExpenseCategoryResource>;
expenseSubCategories?: Array<ExpenseSubCategoryResource>;
};
...
expenseTypes?: Array<{value:ExpenseType;label:string;}>;
expenseType: ExpenseType;
expenseSubCategories?: {data:Array<ExpenseSubCategoryResource>;links:Array<{url:string;label:string;active:boolean;}>;meta:{current_page:number;first_page_url:string;from:number;last_page:number;last_page_url:string;next_page_url:string;path:string;per_page:number;prev_page_url:string;to:number;total:number;};};
trashedFilters?: Array<{value:TrashedFilter;label:string;}>;
expenseCategories?: Array<ExpenseCategoryResource>;
};
...
team: TeamListResource;
projectDepartments?: {data:Array<ProjectDepartmentResource>;links:Array<{url:string;label:string;active:boolean;}>;meta:{current_page:number;first_page_url:string;from:number;last_page:number;last_page_url:string;next_page_url:string;path:string;per_page:number;prev_page_url:string;to:number;total:number;};};
trashedFilters?: Array<{value:TrashedFilter;label:string;}>;
};
...
teams?: {data:Array<TeamIndexResource>;links:Array<{url:string;label:string;active:boolean;}>;meta:{current_page:number;first_page_url:string;from:number;last_page:number;last_page_url:string;next_page_url:string;path:string;per_page:number;prev_page_url:string;to:number;total:number;};};
trashedFilters?: Array<{value:TrashedFilter;label:string;}>;
};
...
users?: {data:Array<UserMemberIndexResource>;links:Array<{url:string;label:string;active:boolean;}>;meta:{current_page:number;first_page_url:string;from:number;last_page:number;last_page_url:string;next_page_url:string;path:string;per_page:number;prev_page_url:string;to:number;total:number;};};
trashedFilters?: Array<{value:TrashedFilter;label:string;}>;
};
