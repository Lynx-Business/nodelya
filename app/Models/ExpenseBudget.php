...
class ExpenseBudget extends Model
{
    ...
    {
        return Attribute::get(fn (): ExpenseType => match ($this->model_type) {
            Relation::getMorphAlias(Contractor::class) => ExpenseType::CONTRACTOR,
            Relation::getMorphAlias(Employee::class)   => ExpenseType::EMPLOYEE,
